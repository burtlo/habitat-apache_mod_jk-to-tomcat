...
pkg_deps=(core/glibc core/expat core/libiconv core/apr franklinwebber/apr-util core/pcre core/zlib core/openssl core/gcc-libs core/perl)
...
do_build() {
    ./configure --prefix="$pkg_prefix" \
                ...
                --with-apr-util="$(pkg_path_for franklinwebber/apr-util)" \
